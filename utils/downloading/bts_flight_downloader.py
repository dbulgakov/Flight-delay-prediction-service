...
class BTSFlightDataDownloader(object):
    ...
    def __common_data_fields(self):
        return [
            ...
            ('varlist', (
                'FL_DATE,MONTH,DAY_OF_WEEK,QUARTER,FL_NUM,COP_UNIQUE_CARRIER,CTAIL_NUM'
    ...
    def __sql_query_filed(self):
        return ('sqlstr', (
            ' SELECT FL_DATE,MONTH,DAY_OF_WEEK,QUARTER,FL_NUM,OP_UNIQUE_CARRIER,TAIL_NUM,ORIGIN_AIRPORT_ID'
